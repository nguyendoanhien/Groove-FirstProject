...
{
    public partial class updateusp_Message_GetTheLatest_Image : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
					...
					-- Edite date: 07-08-2019
                    -- Description:	GetLastestMessageOfAConversation
                    -- =============================================
                    ALTER PROCEDURE [dbo].[usp_Message_GetTheLatest] 
                    ...
                    BEGIN
	                    ...
	                    WHERE P.UserId = @UserId AND C.IsGroup = 0
                        ...
                        BEGIN
							...
							DECLARE @TypeMessage nvarchar(256)
							SET @TypeMessage = (
								                    SELECT TOP(1) M.Type
								                    FROM UserInfoContact UC
								                    INNER JOIN UserInfo UI ON UI.Id = UC.UserId
								                    ...
								                    WHERE UI.UserId = @UserId
								                    ORDER BY M.CreatedOn DESC)
							IF(@TypeMessage = 'Image') SET @LastMessage = '[Image]'
