...
export class RegisterComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.registerForm = this._formBuilder.group({
            ...
            email: [this.registerModel.email, [Validators.required,Validators.pattern("^[a-z][a-z0-9_\.]{5,32}@[a-z0-9]{2,}(\.[a-z0-9]{2,4}){1,2}$")]],
            password: [this.registerModel.password, [Validators.required, Validators.pattern(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[#$^+=!*()@%&]).{8,40}$/)]],
